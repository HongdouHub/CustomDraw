...
public class CanvasDrawView extends View {
    ...
    public CanvasDrawView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint = new Paint();
        mDensity = ScreenConstants.DENSITY;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 绘制扇形
        RectF re1arc1 = new RectF(110 * mDensity, 430 * mDensity, 210 * mDensity, 530 * mDensity);
        canvas.drawArc(re1arc1,30,225,true, mPaint);
...
//        mShader = new RadialGradient(200 * mDensity, 40 * mDensity,30 * mDensity,
//                Color.RED,Color.YELLOW, Shader.TileMode.MIRROR);
        ...
        // 绘制扇形
        RectF re1arc2 = new RectF(220 * mDensity, 430 * mDensity, 320 * mDensity, 530 * mDensity);
        canvas.drawArc(re1arc2,30,225,true, mPaint);
        ...
        canvas.drawText("长方形", 240 * mDensity, 175 * mDensity, mPaint);
        canvas.drawText("圆角矩形", 230 * mDensity, 220 * mDensity, mPaint);
        canvas.drawText("椭圆形", 240 * mDensity, 260 * mDensity, mPaint);
        canvas.drawText("三角形", 240 * mDensity, 325 * mDensity, mPaint);
        canvas.drawText("五角形", 240 * mDensity, 390 * mDensity, mPaint);
    }
}
